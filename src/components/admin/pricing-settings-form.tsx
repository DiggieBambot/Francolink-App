  ...
  return (
    <div className="space-y-8 max-w-4xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
          <h3 className="text-lg font-bold flex items-center gap-2 mb-6 text-gray-900">
            <DollarSign className="w-5 h-5 text-blue-600" /> Student Subscription (B2C)
          </h3>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-blue-600 uppercase mb-1">Sale Price ($)</label>
                <input 
                  type="number" 
                  step="0.01"
