    ...
    <div className="min-h-screen bg-slate-50">
      <div className="mx-auto max-w-5xl px-6 py-14">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {/* Student */}
          <div className="flex flex-col rounded-2xl border-2 border-primary-200 bg-white p-7 shadow-sm">
            <div className="flex items-center gap-3">
              <span className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary-100 text-primary-700">
            ...
            <Link
              href="/signup"
              className="mt-6 inline-flex items-center justify-center gap-2 rounded-lg bg-primary-600 px-5 py-3 text-sm font-semibold text-white hover:bg-primary-700"
            >
          ...
          <div className="flex flex-col rounded-2xl border-2 border-secondary-200 bg-white p-7 shadow-sm">
            ...
            >
              Sign up as a Tutor <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-500">
          Just browsing?{" "}
          <Link href="/library" className="font-medium text-primary-700 hover:underline">
            Explore the free lesson catalogue
          </Link>{" "}
          ·{" "}
          <Link href="/how-it-works" className="font-medium text-primary-700 hover:underline">
            See how it works
          </Link>
        </p>
