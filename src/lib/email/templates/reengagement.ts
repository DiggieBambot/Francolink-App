...
//     CTA → /pricing
//
// Voice is "Tutor Njinu" — warm, concise, encouraging, one CTA per email.
...
If anything's confusing or you'd rather just hop on a quick call with a tutor first, hit reply — I read every email.
...
When you're ready to go deeper into ${lang}, Premium unlocks all 4 CEFR levels (A1 → B2), every lesson, plus access to a live tutor (that's people like me) and the AI conversation partner whenever you want to practise speaking.
...
`;
  ...
  const html = shell({
    ...
    bodyHtml: `
      ...
      <p style="margin:0 0 14px 0;">When you're ready to go deeper into ${escape(lang)}, <strong>Premium</strong> unlocks all 4 CEFR levels (A1 → B2), every lesson, plus access to a live tutor (that's people like me) and the AI conversation partner whenever you want to practise speaking.</p>
